...
featurize_tcrs <- function(data, chain, cdr3_align="mid", cdr_only = TRUE, add_ints52 = TRUE, return_seq_grid=FALSE, do_jgenes = TRUE, restrict_length=TRUE){
  ...
  atch = tcrpheno:::atch
  TRBVref = tcrpheno:::TRBVref
  TRBJref = tcrpheno:::TRBJref
  TRAVref = tcrpheno:::TRAVref
  TRAJref = tcrpheno:::TRAJref
  ...
  TRBVgrid = tcrpheno:::TRBVgrid
  TRBJgrid = tcrpheno:::TRBJgrid
  TRAVgrid = tcrpheno:::TRAVgrid
  TRAJgrid = tcrpheno:::TRAJgrid
